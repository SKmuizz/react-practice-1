...
function App() {
  ...
  const updateResult = (action) => {
      if (action == 'add') {
        ...
        setHistory((previousHistory) =>[newhistory,...previousHistory]);
      }
      else if (action == 'sub') {
  ...
  return (
    <div className="container row">
      <div className="container col-md-8 md">
        ...
        <div>
          <input type="button" className="m-4 p-4" value={"+"} onClick={() => updateResult('add')} />
          <input type="button" className="m-4 p-4" value={"-"} onClick={() => updateResult('sub')} />
          <input type="button" className="m-4 p-4" value={"*"} onClick={() => updateResult('mul')} />
          <input type="button" className="m-4 p-4" value={"/"} onClick={() => updateResult('div')} />
          <input type="button" className="m-4 p-4" value={"c"} onClick={() => updateResult('c')} />
        </div>
      </div>
